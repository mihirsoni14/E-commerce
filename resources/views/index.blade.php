                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            @foreach ($categorys as $category)
                                <li class="nav-item">
                                    <a data-id="{{$category->id}}" class="d-flex m-2 py-2 bg-light rounded-pill category-labels"
                                        data-bs-toggle="pill">
                            ...
                            <div class="col-lg-12">
                                <div id="loader" style="display: none;position: relative;">
                                    <img src="https://i.gifer.com/ZZ5H.gif"
                                        style="position: absolute; top: 200px; z-index: 3;" width="50px" alt="Loading...">
                                </div>
                                <div class="row g-4 ajax-list">
                                    @include("ajax-searchedData")
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('script')
    <script>
        $(document).ready(function () {
            $('.category-labels').on("click", function () {
